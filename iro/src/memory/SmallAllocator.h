 ...
 *
 *  NOTE!!! At the time of writing I do not use this anywhere and I have NO
 *          idea if it actually works! Yet another thing I implemented then
 *          found not useful I guess.
 */
