...
/* Compile hash: 2U4wsr1JwXpcb2LJNB1LoS2vSF5f */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
typedef nlmulret_nlboolean_nlint64_nluint8 (*function_3HNHEGbg5vJZDY5hN)(nlstring_ptr, int64_t);
typedef struct nlmulret_function_3HNHEGbg5vJZDY5hN_nlstring_ptr_nlint64 {
  function_3HNHEGbg5vJZDY5hN r1;
  nlstring_ptr r2;
  int64_t r3;
} nlmulret_function_3HNHEGbg5vJZDY5hN_nlstring_ptr_nlint64;
static NELUA_INLINE nlmulret_function_3HNHEGbg5vJZDY5hN_nlstring_ptr_nlint64 nelua_ipairs_1(nlstring_ptr a);
...
typedef nlmulret_nlboolean_nlint64_main_Tile_ptr (*function_58tSM2G9KSg8qhvEv)(main_Tile_arr49_ptr, int64_t);
typedef struct main_Object main_Object;
typedef main_Object* main_Object_ptr;
struct list_Node_7 {
  main_Object_ptr data;
  list_Node_7_ptr next;
  list_Node_7_ptr prev;
};
NELUA_STATIC_ASSERT(sizeof(list_Node_7) == 24 && NELUA_ALIGNOF(list_Node_7) == 8, "Nelua and C disagree on type size or align");
...
NELUA_STATIC_ASSERT(sizeof(pool_Slot_14) == 24 && NELUA_ALIGNOF(pool_Slot_14) == 8, "Nelua and C disagree on type size or align");
struct pool_Chunk_14 {
  pool_Chunk_14_ptr next;
  pool_Slot_14 slots[16];
};
NELUA_STATIC_ASSERT(sizeof(pool_Chunk_14) == 392 && NELUA_ALIGNOF(pool_Chunk_14) == 8, "Nelua and C disagree on type size or align");
typedef struct nlmulret_function_58tSM2G9KSg8qhvEv_main_Tile_arr49_ptr_nlint64 {
  function_58tSM2G9KSg8qhvEv r1;
  main_Tile_arr49_ptr r2;
  int64_t r3;
} nlmulret_function_58tSM2G9KSg8qhvEv_main_Tile_arr49_ptr_nlint64;
static NELUA_INLINE nlmulret_function_58tSM2G9KSg8qhvEv_main_Tile_arr49_ptr_nlint64 nelua_mipairs_1(main_Tile_arr49_ptr a);
...
typedef nlmulret_nlboolean_nlpointer_nlusize (*function_4rYdFSRUtGCy9dmPR)(nelua_hashmap_iteratorT_1_ptr, void*);
...
typedef struct nlmulret_function_4rYdFSRUtGCy9dmPR_nelua_hashmap_iteratorT_1_nlpointer {
  function_4rYdFSRUtGCy9dmPR r1;
  nelua_hashmap_iteratorT_1 r2;
  void* r3;
} nlmulret_function_4rYdFSRUtGCy9dmPR_nelua_hashmap_iteratorT_1_nlpointer;
static NELUA_INLINE nlmulret_function_4rYdFSRUtGCy9dmPR_nelua_hashmap_iteratorT_1_nlpointer nelua_pairs_1(nelua_hashmap_pointer__usize__ptr a);
...
typedef nlmulret_nlboolean_nlpointer_nelua_GCItem_ptr (*function_3G4KcE6UoP6GoYaNm)(nelua_hashmap_iteratorT_ptr, void*);
...
typedef struct nlmulret_function_3G4KcE6UoP6GoYaNm_nelua_hashmap_iteratorT_nlpointer {
  function_3G4KcE6UoP6GoYaNm r1;
  nelua_hashmap_iteratorT r2;
  void* r3;
} nlmulret_function_3G4KcE6UoP6GoYaNm_nelua_hashmap_iteratorT_nlpointer;
static NELUA_INLINE nlmulret_function_3G4KcE6UoP6GoYaNm_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a);
...
static NELUA_INLINE nlmulret_function_3G4KcE6UoP6GoYaNm_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self);
...
static NELUA_INLINE nlmulret_function_4rYdFSRUtGCy9dmPR_nelua_hashmap_iteratorT_1_nlpointer nelua_hashmap_pointer__usize____pairs(nelua_hashmap_pointer__usize__ptr self);
...
typedef void (*function_2yuirqQY4xqKH3qqt)(nelua_GC_ptr);
...
typedef void (*function_57DFCU4p57qcsWw1t)(void*, void*);
static bool nelua_GC_step(nelua_GC_ptr self);
static void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_57DFCU4p57qcsWw1t finalizer, void* userdata);
...
typedef int (*function_38TcU9M7FcG3gWQmw)(int, nlcstring_ptr);
...
typedef void (*function_4hF1KnSdaxMWstMTJ)(void*, main_event_Event_AnimalDeath_ptr);
struct event_Subscription {
  void* subscriber;
  function_4hF1KnSdaxMWstMTJ handler;
};
...
NELUA_STATIC_ASSERT(sizeof(pool_Slot) == 16 && NELUA_ALIGNOF(pool_Slot) == 8, "Nelua and C disagree on type size or align");
struct pool_Chunk {
  pool_Chunk_ptr next;
  pool_Slot slots[16];
};
NELUA_STATIC_ASSERT(sizeof(pool_Chunk) == 264 && NELUA_ALIGNOF(pool_Chunk) == 8, "Nelua and C disagree on type size or align");
...
NELUA_STATIC_ASSERT(sizeof(list_Node) == 16 && NELUA_ALIGNOF(list_Node) == 8, "Nelua and C disagree on type size or align");
union pool_Slot_1 {
...
typedef void (*function_ZsqrH41cFfsXDSUq)(void*, main_event_Event_PlayerAttack_ptr);
struct event_Subscription_1 {
  void* subscriber;
  function_ZsqrH41cFfsXDSUq handler;
};
...
typedef void (*function_wvCfUMjKjA3ntWyU)(void*, main_event_Event_KeyPressed_ptr);
struct event_Subscription_2 {
  void* subscriber;
  function_wvCfUMjKjA3ntWyU handler;
};
...
typedef void (*function_hfcdYQNTXh8PUQfD)(void*, main_event_Event_AfterEventProcessing_ptr);
struct event_Subscription_3 {
  void* subscriber;
  function_hfcdYQNTXh8PUQfD handler;
};
...
typedef void (*function_uinHaMwaC2yxtr5E)(void*, main_event_Event_ObjectMoved_ptr);
struct event_Subscription_4 {
  void* subscriber;
  function_uinHaMwaC2yxtr5E handler;
};
...
typedef void (*function_2FgKCBAhX2MuB71cZ)(void*, main_event_Event_ObjectTryMove_ptr);
struct event_Subscription_5 {
  void* subscriber;
  function_2FgKCBAhX2MuB71cZ handler;
};
...
typedef void (*function_Jg2sxywD8zE8hxJj)(void*, main_event_Event_AnimalDamaged_ptr);
struct event_Subscription_6 {
  void* subscriber;
  function_Jg2sxywD8zE8hxJj handler;
};
...
NELUA_STATIC_ASSERT(sizeof(list_Node_8) == 16 && NELUA_ALIGNOF(list_Node_8) == 8, "Nelua and C disagree on type size or align");
union pool_Slot_15 {
  pool_Slot_15_ptr next_free_slot;
  list_Node_8 element;
};
NELUA_STATIC_ASSERT(sizeof(pool_Slot_15) == 16 && NELUA_ALIGNOF(pool_Slot_15) == 8, "Nelua and C disagree on type size or align");
struct pool_Chunk_15 {
  pool_Chunk_15_ptr next;
  pool_Slot_15 slots[16];
};
NELUA_STATIC_ASSERT(sizeof(pool_Chunk_15) == 264 && NELUA_ALIGNOF(pool_Chunk_15) == 8, "Nelua and C disagree on type size or align");
...
static NELUA_NOINLINE main_Player_ptr nelua_GCAllocator_new_19(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags);
static void nelua_assert_line_44(bool cond, nlstring msg);
static NELUA_NOINLINE main_Animal_ptr nelua_GCAllocator_new_20(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags);
...
static event_Subscription_ptr pool_PoolT_add(pool_PoolT_ptr self);
...
static list_Node_ptr pool_PoolT_1_add(pool_PoolT_1_ptr self);
...
static event_Subscription_1_ptr pool_PoolT_2_add(pool_PoolT_2_ptr self);
...
static list_Node_1_ptr pool_PoolT_3_add(pool_PoolT_3_ptr self);
...
static event_Subscription_2_ptr pool_PoolT_4_add(pool_PoolT_4_ptr self);
...
static list_Node_2_ptr pool_PoolT_5_add(pool_PoolT_5_ptr self);
...
static event_Subscription_4_ptr pool_PoolT_8_add(pool_PoolT_8_ptr self);
...
static list_Node_4_ptr pool_PoolT_9_add(pool_PoolT_9_ptr self);
...
static event_Subscription_5_ptr pool_PoolT_10_add(pool_PoolT_10_ptr self);
...
static list_Node_5_ptr pool_PoolT_11_add(pool_PoolT_11_ptr self);
...
static event_Subscription_6_ptr pool_PoolT_12_add(pool_PoolT_12_ptr self);
...
static list_Node_6_ptr pool_PoolT_13_add(pool_PoolT_13_ptr self);
...
static void pool_PoolT_14_remove(pool_PoolT_14_ptr self, list_Node_7_ptr x);
...
static list_Node_7_ptr list_DList_1_insertBefore(list_DList_1_ptr self, list_Node_7_ptr x, main_Object_ptr v);
static list_Node_7_ptr list_DList_1_pushHead(list_DList_1_ptr self, main_Object_ptr x);
static void list_DList_1_unlink(list_DList_1_ptr self, list_Node_7_ptr x);
static void list_DList_1_remove(list_DList_1_ptr self, list_Node_7_ptr n);
static bool list_DList_1_isEmpty(list_DList_1_ptr self);
...
static list_Node_ptr list_SListT_push(list_SListT_ptr self, event_Subscription_ptr x);
typedef struct nlmulret_nlboolean_list_Node_ptr_event_Subscription_ptr {
  bool r1;
  list_Node_ptr r2;
  event_Subscription_ptr r3;
} nlmulret_nlboolean_list_Node_ptr_event_Subscription_ptr;
static nlmulret_nlboolean_list_Node_ptr_event_Subscription_ptr list_SListT___next(list_SListT_ptr self, list_Node_ptr n);
typedef nlmulret_nlboolean_list_Node_ptr_event_Subscription_ptr (*function_4uNKE5NRnqLqCGAQu)(list_SListT_ptr, list_Node_ptr);
typedef struct nlmulret_function_4uNKE5NRnqLqCGAQu_list_SListT_ptr_nlnilptr {
  function_4uNKE5NRnqLqCGAQu r1;
  list_SListT_ptr r2;
  void* r3;
} nlmulret_function_4uNKE5NRnqLqCGAQu_list_SListT_ptr_nlnilptr;
static nlmulret_function_4uNKE5NRnqLqCGAQu_list_SListT_ptr_nlnilptr list_SListT_each(list_SListT_ptr self);
...
static list_Node_1_ptr list_SListT_1_push(list_SListT_1_ptr self, event_Subscription_1_ptr x);
typedef struct nlmulret_nlboolean_list_Node_1_ptr_event_Subscription_1_ptr {
  bool r1;
  list_Node_1_ptr r2;
  event_Subscription_1_ptr r3;
} nlmulret_nlboolean_list_Node_1_ptr_event_Subscription_1_ptr;
static nlmulret_nlboolean_list_Node_1_ptr_event_Subscription_1_ptr list_SListT_1___next(list_SListT_1_ptr self, list_Node_1_ptr n);
typedef nlmulret_nlboolean_list_Node_1_ptr_event_Subscription_1_ptr (*function_29MTnF5pPdQHkucTx)(list_SListT_1_ptr, list_Node_1_ptr);
typedef struct nlmulret_function_29MTnF5pPdQHkucTx_list_SListT_1_ptr_nlnilptr {
  function_29MTnF5pPdQHkucTx r1;
  list_SListT_1_ptr r2;
  void* r3;
} nlmulret_function_29MTnF5pPdQHkucTx_list_SListT_1_ptr_nlnilptr;
static nlmulret_function_29MTnF5pPdQHkucTx_list_SListT_1_ptr_nlnilptr list_SListT_1_each(list_SListT_1_ptr self);
...
static list_Node_2_ptr list_SListT_2_push(list_SListT_2_ptr self, event_Subscription_2_ptr x);
typedef struct nlmulret_nlboolean_list_Node_2_ptr_event_Subscription_2_ptr {
  bool r1;
  list_Node_2_ptr r2;
  event_Subscription_2_ptr r3;
} nlmulret_nlboolean_list_Node_2_ptr_event_Subscription_2_ptr;
static nlmulret_nlboolean_list_Node_2_ptr_event_Subscription_2_ptr list_SListT_2___next(list_SListT_2_ptr self, list_Node_2_ptr n);
typedef nlmulret_nlboolean_list_Node_2_ptr_event_Subscription_2_ptr (*function_4hLPKyqBUeKea1Uew)(list_SListT_2_ptr, list_Node_2_ptr);
typedef struct nlmulret_function_4hLPKyqBUeKea1Uew_list_SListT_2_ptr_nlnilptr {
  function_4hLPKyqBUeKea1Uew r1;
  list_SListT_2_ptr r2;
  void* r3;
} nlmulret_function_4hLPKyqBUeKea1Uew_list_SListT_2_ptr_nlnilptr;
static nlmulret_function_4hLPKyqBUeKea1Uew_list_SListT_2_ptr_nlnilptr list_SListT_2_each(list_SListT_2_ptr self);
...
static list_Node_4_ptr list_SListT_4_push(list_SListT_4_ptr self, event_Subscription_4_ptr x);
typedef struct nlmulret_nlboolean_list_Node_4_ptr_event_Subscription_4_ptr {
  bool r1;
  list_Node_4_ptr r2;
  event_Subscription_4_ptr r3;
} nlmulret_nlboolean_list_Node_4_ptr_event_Subscription_4_ptr;
static nlmulret_nlboolean_list_Node_4_ptr_event_Subscription_4_ptr list_SListT_4___next(list_SListT_4_ptr self, list_Node_4_ptr n);
typedef nlmulret_nlboolean_list_Node_4_ptr_event_Subscription_4_ptr (*function_2ugVFY8DvpLjaCeM5)(list_SListT_4_ptr, list_Node_4_ptr);
typedef struct nlmulret_function_2ugVFY8DvpLjaCeM5_list_SListT_4_ptr_nlnilptr {
  function_2ugVFY8DvpLjaCeM5 r1;
  list_SListT_4_ptr r2;
  void* r3;
} nlmulret_function_2ugVFY8DvpLjaCeM5_list_SListT_4_ptr_nlnilptr;
static nlmulret_function_2ugVFY8DvpLjaCeM5_list_SListT_4_ptr_nlnilptr list_SListT_4_each(list_SListT_4_ptr self);
...
static list_Node_5_ptr list_SListT_5_push(list_SListT_5_ptr self, event_Subscription_5_ptr x);
...
typedef struct nlmulret_nlboolean_list_Node_5_ptr_event_Subscription_5_ptr {
  bool r1;
  list_Node_5_ptr r2;
  event_Subscription_5_ptr r3;
} nlmulret_nlboolean_list_Node_5_ptr_event_Subscription_5_ptr;
static nlmulret_nlboolean_list_Node_5_ptr_event_Subscription_5_ptr list_SListT_5___next(list_SListT_5_ptr self, list_Node_5_ptr n);
typedef nlmulret_nlboolean_list_Node_5_ptr_event_Subscription_5_ptr (*function_4uL4La9ggPQo3LWG)(list_SListT_5_ptr, list_Node_5_ptr);
typedef struct nlmulret_function_4uL4La9ggPQo3LWG_list_SListT_5_ptr_nlnilptr {
  function_4uL4La9ggPQo3LWG r1;
  list_SListT_5_ptr r2;
  void* r3;
} nlmulret_function_4uL4La9ggPQo3LWG_list_SListT_5_ptr_nlnilptr;
static nlmulret_function_4uL4La9ggPQo3LWG_list_SListT_5_ptr_nlnilptr list_SListT_5_each(list_SListT_5_ptr self);
...
static list_Node_6_ptr list_SListT_6_push(list_SListT_6_ptr self, event_Subscription_6_ptr x);
typedef struct nlmulret_nlboolean_list_Node_6_ptr_event_Subscription_6_ptr {
  bool r1;
  list_Node_6_ptr r2;
  event_Subscription_6_ptr r3;
} nlmulret_nlboolean_list_Node_6_ptr_event_Subscription_6_ptr;
static nlmulret_nlboolean_list_Node_6_ptr_event_Subscription_6_ptr list_SListT_6___next(list_SListT_6_ptr self, list_Node_6_ptr n);
typedef nlmulret_nlboolean_list_Node_6_ptr_event_Subscription_6_ptr (*function_36Fxu1YUGTnPViwL1)(list_SListT_6_ptr, list_Node_6_ptr);
typedef struct nlmulret_function_36Fxu1YUGTnPViwL1_list_SListT_6_ptr_nlnilptr {
  function_36Fxu1YUGTnPViwL1 r1;
  list_SListT_6_ptr r2;
  void* r3;
} nlmulret_function_36Fxu1YUGTnPViwL1_list_SListT_6_ptr_nlnilptr;
static nlmulret_function_36Fxu1YUGTnPViwL1_list_SListT_6_ptr_nlnilptr list_SListT_6_each(list_SListT_6_ptr self);
...
typedef void (*function_4SZqu2mhaPbEhCt9x)(void*, main_event_Event_AnimalDeath_ptr);
static void event_SubListT_sub(event_SubListT_ptr self, void* subscriber, function_4SZqu2mhaPbEhCt9x handler);
static void event_SubListT_emit(event_SubListT_ptr self, main_event_Event_AnimalDeath_ptr event);
...
typedef void (*function_5aVoqxB6gdCjr8Dbk)(void*, main_event_Event_PlayerAttack_ptr);
static void event_SubListT_1_sub(event_SubListT_1_ptr self, void* subscriber, function_5aVoqxB6gdCjr8Dbk handler);
static void event_SubListT_1_emit(event_SubListT_1_ptr self, main_event_Event_PlayerAttack_ptr event);
...
typedef void (*function_2knsKLmUuKT1XNx37)(void*, main_event_Event_KeyPressed_ptr);
static void event_SubListT_2_sub(event_SubListT_2_ptr self, void* subscriber, function_2knsKLmUuKT1XNx37 handler);
static void event_SubListT_2_emit(event_SubListT_2_ptr self, main_event_Event_KeyPressed_ptr event);
...
typedef void (*function_4pPo1THfgEzdsRKw6)(void*, main_event_Event_ObjectMoved_ptr);
static void event_SubListT_4_sub(event_SubListT_4_ptr self, void* subscriber, function_4pPo1THfgEzdsRKw6 handler);
static void event_SubListT_4_emit(event_SubListT_4_ptr self, main_event_Event_ObjectMoved_ptr event);
...
typedef void (*function_3FbNvqKjJwxQ8PTnB)(void*, main_event_Event_ObjectTryMove_ptr);
static void event_SubListT_5_sub(event_SubListT_5_ptr self, void* subscriber, function_3FbNvqKjJwxQ8PTnB handler);
...
typedef void (*function_21Fh8bq1X8fScyAZq)(void*, main_event_Event_AnimalDamaged_ptr);
static void event_SubListT_6_sub(event_SubListT_6_ptr self, void* subscriber, function_21Fh8bq1X8fScyAZq handler);
static void event_SubListT_6_emit(event_SubListT_6_ptr self, main_event_Event_AnimalDamaged_ptr event);
...
typedef int (*function_5dN8ka29L8g7zvVdF)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_5dN8ka29L8g7zvVdF closef;
};
...
struct main_EventBusT {
  event_SubListT sublist_AnimalDeath;
  event_SubListT_1 sublist_PlayerAttack;
  event_SubListT_2 sublist_KeyPressed;
  event_SubListT_3 sublist_AfterEventProcessing;
  event_SubListT_4 sublist_ObjectMoved;
  event_SubListT_5 sublist_ObjectTryMove;
  event_SubListT_6 sublist_AnimalDamaged;
};
...
typedef void (*function_48GYbkTX7Y82defP6)(main_Player_ptr, main_event_Event_KeyPressed_ptr);
static void main_EventBusT_subscribeTo_1(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_48GYbkTX7Y82defP6 handler);
typedef void (*function_56tZRi33ZZDi2HbYj)(void*, main_event_Event_KeyPressed_ptr);
typedef void (*function_2dyoW7VdhKnP6RUM7)(main_Player_ptr, main_event_Event_AnimalDamaged_ptr);
static void main_EventBusT_subscribeTo_2(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_2dyoW7VdhKnP6RUM7 handler);
typedef void (*function_4VfZmwtMyXQD3i1Rs)(void*, main_event_Event_AnimalDamaged_ptr);
typedef void (*function_4JskZSUwhCcUTtH3C)(main_Animal_ptr, main_event_Event_PlayerAttack_ptr);
static void main_EventBusT_subscribeTo_3(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_4JskZSUwhCcUTtH3C handler);
typedef void (*function_J8dzrJrzsdVnEJaD)(void*, main_event_Event_PlayerAttack_ptr);
typedef struct main_Narrator main_Narrator;
typedef main_Narrator* main_Narrator_ptr;
typedef void (*function_5TGKfYNMYuyxx1khX)(main_Narrator_ptr, main_event_Event_PlayerAttack_ptr);
struct main_Narrator {};
static void main_EventBusT_subscribeTo_4(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_5TGKfYNMYuyxx1khX handler);
typedef void (*function_NPyjwbqhFL4oM5ME)(void*, main_event_Event_PlayerAttack_ptr);
typedef void (*function_35SnSF6zavxH1fTfw)(main_Narrator_ptr, main_event_Event_ObjectMoved_ptr);
static void main_EventBusT_subscribeTo_5(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_35SnSF6zavxH1fTfw handler);
typedef void (*function_26hVMSJqZSkzVXCP9)(void*, main_event_Event_ObjectMoved_ptr);
typedef void (*function_2zgpo2WvuXsG7czPg)(main_Narrator_ptr, main_event_Event_AnimalDeath_ptr);
static void main_EventBusT_subscribeTo_6(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_2zgpo2WvuXsG7czPg handler);
typedef void (*function_vFwBy7EysRkFoTRv)(void*, main_event_Event_AnimalDeath_ptr);
typedef struct main_Map main_Map;
typedef main_Map* main_Map_ptr;
typedef void (*function_2eEJ4du7BDE4Fsd7P)(main_Map_ptr, main_event_Event_ObjectTryMove_ptr);
struct main_Map {
...
static void main_EventBusT_subscribeTo_7(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_2eEJ4du7BDE4Fsd7P handler);
typedef void (*function_4EUBvqzddbbhyU6Uh)(void*, main_event_Event_ObjectTryMove_ptr);
typedef void (*function_5CQuLWJt28bUm2ktu)(main_Map_ptr, main_event_Event_ObjectMoved_ptr);
static void main_EventBusT_subscribeTo_8(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_5CQuLWJt28bUm2ktu handler);
typedef void (*function_49FWJNo9sTqAxBE8z)(void*, main_event_Event_ObjectMoved_ptr);
...
static void main_Object_subscribeTo_1(main_Player_ptr self, nlniltype event, function_48GYbkTX7Y82defP6 handler);
static void main_Object_subscribeTo_2(main_Player_ptr self, nlniltype event, function_2dyoW7VdhKnP6RUM7 handler);
static void main_Object_subscribeTo_3(main_Animal_ptr self, nlniltype event, function_4JskZSUwhCcUTtH3C handler);
...
static void main_Narrator_subscribeTo_1(main_Narrator_ptr self, nlniltype event, function_5TGKfYNMYuyxx1khX handler);
static void main_Narrator_subscribeTo_2(main_Narrator_ptr self, nlniltype event, function_35SnSF6zavxH1fTfw handler);
static void main_Narrator_subscribeTo_3(main_Narrator_ptr self, nlniltype event, function_2zgpo2WvuXsG7czPg handler);
...
static list_Node_7_ptr main_Tile_addObject_1(main_Tile_ptr self, main_Object_ptr ptr);
static list_Node_7_ptr main_Tile_addObject_2(main_Tile_ptr self, main_Player_ptr ptr);
static list_Node_7_ptr main_Tile_addObject_3(main_Tile_ptr self, main_Animal_ptr ptr);
static void main_Tile_removeObject_1(main_Tile_ptr self, main_Object_ptr ptr);
static void main_Map_subscribeTo_1(main_Map_ptr self, nlniltype event, function_2eEJ4du7BDE4Fsd7P handler);
static void main_Map_subscribeTo_2(main_Map_ptr self, nlniltype event, function_5CQuLWJt28bUm2ktu handler);
...
nlmulret_function_3HNHEGbg5vJZDY5hN_nlstring_ptr_nlint64 nelua_ipairs_1(nlstring_ptr a) {
  return (nlmulret_function_3HNHEGbg5vJZDY5hN_nlstring_ptr_nlint64){nelua_ipairs_next, a, 0};
}
...
nlmulret_function_58tSM2G9KSg8qhvEv_main_Tile_arr49_ptr_nlint64 nelua_mipairs_1(main_Tile_arr49_ptr a) {
  return (nlmulret_function_58tSM2G9KSg8qhvEv_main_Tile_arr49_ptr_nlint64){nelua_mipairs_next, a, -1};
}
nlmulret_function_4rYdFSRUtGCy9dmPR_nelua_hashmap_iteratorT_1_nlpointer nelua_pairs_1(nelua_hashmap_pointer__usize__ptr a) {
  nlmulret_function_4rYdFSRUtGCy9dmPR_nelua_hashmap_iteratorT_1_nlpointer _ret_1 = nelua_hashmap_pointer__usize____pairs(a);
  return (nlmulret_function_4rYdFSRUtGCy9dmPR_nelua_hashmap_iteratorT_1_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
nlmulret_function_3G4KcE6UoP6GoYaNm_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a) {
  nlmulret_function_3G4KcE6UoP6GoYaNm_nelua_hashmap_iteratorT_nlpointer _ret_1 = nelua_hashmap_pointer__GCItem____mpairs(a);
  return (nlmulret_function_3G4KcE6UoP6GoYaNm_nelua_hashmap_iteratorT_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
nlmulret_function_3G4KcE6UoP6GoYaNm_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self) {
  return (nlmulret_function_3G4KcE6UoP6GoYaNm_nelua_hashmap_iteratorT_nlpointer){nelua_hashmap_iteratorT_mnext, (nelua_hashmap_iteratorT){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
nlmulret_function_4rYdFSRUtGCy9dmPR_nelua_hashmap_iteratorT_1_nlpointer nelua_hashmap_pointer__usize____pairs(nelua_hashmap_pointer__usize__ptr self) {
  return (nlmulret_function_4rYdFSRUtGCy9dmPR_nelua_hashmap_iteratorT_1_nlpointer){nelua_hashmap_iteratorT_1_next, (nelua_hashmap_iteratorT_1){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
void nelua_GC_mark(nelua_GC_ptr self) {
  {
    nlmulret_function_4rYdFSRUtGCy9dmPR_nelua_hashmap_iteratorT_1_nlpointer _asgnret_1 = nelua_pairs_1((&self->rootitems));
    function_4rYdFSRUtGCy9dmPR __fornext = _asgnret_1.r1;
  ...
  if((self->stackbottom != 0)) {
    volatile function_2yuirqQY4xqKH3qqt scanstack = nelua_GC_scanstack;
    scanstack(self);
  }
...
void nelua_GC_sweep(nelua_GC_ptr self) {
  ...
  {
    nlmulret_function_3G4KcE6UoP6GoYaNm_nelua_hashmap_iteratorT_nlpointer _asgnret_1 = nelua_mpairs_1((&self->items));
    function_3G4KcE6UoP6GoYaNm __fornext = _asgnret_1.r1;
...
void nelua_GC_registerroots(nelua_GC_ptr self) {
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stdin), 8U, 131072U, (function_57DFCU4p57qcsWw1t)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stdout), 8U, 131072U, (function_57DFCU4p57qcsWw1t)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_event_bus), 280U, 131072U, (function_57DFCU4p57qcsWw1t)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_map), 1984U, 131072U, (function_57DFCU4p57qcsWw1t)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stdinfs), 16U, 131072U, (function_57DFCU4p57qcsWw1t)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stdoutfs), 16U, 131072U, (function_57DFCU4p57qcsWw1t)NULL, (void*)NULL);
}
...
void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_57DFCU4p57qcsWw1t finalizer, void* userdata) {
  if(NELUA_UNLIKELY((!(ptr != NULL)))) {
    return;
  }
  ...
  if(NELUA_LIKELY((!nelua_hasflag(flags, 131072U)))) {
    ...
    nelua_assert_line_24(((finalizer == (function_57DFCU4p57qcsWw1t)NULL) && (userdata == (void*)NULL)), ((nlstring){(uint8_t*)"attempt to register a root pointer with finalizer", 49}));
...
int main(int argc, nlcstring_ptr argv) {
  ...
  volatile function_38TcU9M7FcG3gWQmw inner_main = nelua_main;
...
pool_Chunk_ptr nelua_GCAllocator_new_3(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  pool_Chunk_ptr ptr;
  ptr = ((pool_Chunk_ptr)nelua_GCAllocator_alloc0_1((&nelua_gc_allocator), 264U, NELUA_NIL, finalizer, (void*)NULL));
  nelua_assert_line_28((ptr != ((pool_Chunk_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_1_ptr nelua_GCAllocator_new_4(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_29((ptr != ((pool_Chunk_1_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_2_ptr nelua_GCAllocator_new_5(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_30((ptr != ((pool_Chunk_2_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_3_ptr nelua_GCAllocator_new_6(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_31((ptr != ((pool_Chunk_3_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_4_ptr nelua_GCAllocator_new_7(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_32((ptr != ((pool_Chunk_4_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_5_ptr nelua_GCAllocator_new_8(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_33((ptr != ((pool_Chunk_5_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_6_ptr nelua_GCAllocator_new_9(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_34((ptr != ((pool_Chunk_6_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_7_ptr nelua_GCAllocator_new_10(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_35((ptr != ((pool_Chunk_7_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_8_ptr nelua_GCAllocator_new_11(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_36((ptr != ((pool_Chunk_8_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_9_ptr nelua_GCAllocator_new_12(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_37((ptr != ((pool_Chunk_9_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_10_ptr nelua_GCAllocator_new_13(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_38((ptr != ((pool_Chunk_10_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_11_ptr nelua_GCAllocator_new_14(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_39((ptr != ((pool_Chunk_11_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_12_ptr nelua_GCAllocator_new_15(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_40((ptr != ((pool_Chunk_12_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_13_ptr nelua_GCAllocator_new_16(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_41((ptr != ((pool_Chunk_13_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_14_ptr nelua_GCAllocator_new_17(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  ptr = ((pool_Chunk_14_ptr)nelua_GCAllocator_alloc0_1((&nelua_gc_allocator), 392U, NELUA_NIL, finalizer, (void*)NULL));
  nelua_assert_line_42((ptr != ((pool_Chunk_14_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
pool_Chunk_15_ptr nelua_GCAllocator_new_18(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  ptr = ((pool_Chunk_15_ptr)nelua_GCAllocator_alloc0_1((&nelua_gc_allocator), 264U, NELUA_NIL, finalizer, (void*)NULL));
  nelua_assert_line_43((ptr != ((pool_Chunk_15_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
main_Player_ptr nelua_GCAllocator_new_19(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  nelua_GCFinalizerCallback finalizer = (nelua_GCFinalizerCallback)NULL;
  main_Player_ptr ptr;
...
main_Animal_ptr nelua_GCAllocator_new_20(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  nelua_GCFinalizerCallback finalizer = (nelua_GCFinalizerCallback)NULL;
  main_Animal_ptr ptr;
...
main_Player_ptr nelua_new_1(nlniltype what, nlniltype size, nlniltype flags) {
  return nelua_GCAllocator_new_19((&nelua_gc_allocator), NELUA_NIL, NELUA_NIL, NELUA_NIL);
}
...
event_Subscription_ptr pool_PoolT_add(pool_PoolT_ptr self) {
...
list_Node_ptr pool_PoolT_1_add(pool_PoolT_1_ptr self) {
...
event_Subscription_1_ptr pool_PoolT_2_add(pool_PoolT_2_ptr self) {
...
list_Node_1_ptr pool_PoolT_3_add(pool_PoolT_3_ptr self) {
...
event_Subscription_2_ptr pool_PoolT_4_add(pool_PoolT_4_ptr self) {
...
list_Node_2_ptr pool_PoolT_5_add(pool_PoolT_5_ptr self) {
...
event_Subscription_4_ptr pool_PoolT_8_add(pool_PoolT_8_ptr self) {
...
list_Node_4_ptr pool_PoolT_9_add(pool_PoolT_9_ptr self) {
...
event_Subscription_5_ptr pool_PoolT_10_add(pool_PoolT_10_ptr self) {
...
list_Node_5_ptr pool_PoolT_11_add(pool_PoolT_11_ptr self) {
...
event_Subscription_6_ptr pool_PoolT_12_add(pool_PoolT_12_ptr self) {
...
list_Node_6_ptr pool_PoolT_13_add(pool_PoolT_13_ptr self) {
...
void pool_PoolT_14_remove(pool_PoolT_14_ptr self, list_Node_7_ptr x) {
  pool_Slot_14_ptr slot = ((pool_Slot_14_ptr)x);
...
void list_DList_1_init(list_DList_1_ptr self) {
  ...
  self->tail = ((list_Node_7_ptr)NULL);
}
list_Node_7_ptr list_DList_1_insertBefore(list_DList_1_ptr self, list_Node_7_ptr x, main_Object_ptr v) {
...
list_Node_7_ptr list_DList_1_pushHead(list_DList_1_ptr self, main_Object_ptr x) {
  if((self->head != NULL)) {
    return list_DList_1_insertBefore(self, self->head, x);
  }
  self->head = pool_PoolT_14_add((&self->pool));
  self->tail = self->head;
  self->head->data = x;
  return self->head;
}
void list_DList_1_unlink(list_DList_1_ptr self, list_Node_7_ptr x) {
  if((x->prev != NULL)) {
    x->prev->next = x->next;
  } else {
    self->head = x->next;
...
void list_DList_1_remove(list_DList_1_ptr self, list_Node_7_ptr n) {
  list_DList_1_unlink(self, n);
  pool_PoolT_14_remove((&self->pool), n);
}
bool list_DList_1_isEmpty(list_DList_1_ptr self) {
...
list_Node_ptr list_SListT_push(list_SListT_ptr self, event_Subscription_ptr x) {
  list_Node_ptr n = pool_PoolT_1_add((&self->pool));
  n->next = self->head;
  n->data = x;
  self->head = n;
  return n;
}
nlmulret_nlboolean_list_Node_ptr_event_Subscription_ptr list_SListT___next(list_SListT_ptr self, list_Node_ptr n) {
  list_Node_ptr nn = ({
    list_Node_ptr _expr;
    if((!(n != NULL))) {
      _expr = self->head;
  ...
  if((!(nn != NULL))) {
    return (nlmulret_nlboolean_list_Node_ptr_event_Subscription_ptr){false, ((list_Node_ptr)NULL), ((event_Subscription_ptr)NULL)};
  }
  return (nlmulret_nlboolean_list_Node_ptr_event_Subscription_ptr){true, nn, nn->data};
}
nlmulret_function_4uNKE5NRnqLqCGAQu_list_SListT_ptr_nlnilptr list_SListT_each(list_SListT_ptr self) {
  return (nlmulret_function_4uNKE5NRnqLqCGAQu_list_SListT_ptr_nlnilptr){list_SListT___next, self, NULL};
}
void list_SListT_1_init(list_SListT_1_ptr self) {
  pool_PoolT_3_init((&self->pool));
  self->head = ((list_Node_1_ptr)NULL);
}
list_Node_1_ptr list_SListT_1_push(list_SListT_1_ptr self, event_Subscription_1_ptr x) {
  list_Node_1_ptr n = pool_PoolT_3_add((&self->pool));
  n->next = self->head;
  n->data = x;
  self->head = n;
  return n;
}
nlmulret_nlboolean_list_Node_1_ptr_event_Subscription_1_ptr list_SListT_1___next(list_SListT_1_ptr self, list_Node_1_ptr n) {
  list_Node_1_ptr nn = ({
    list_Node_1_ptr _expr;
    if((!(n != NULL))) {
      _expr = self->head;
      goto _doexprlabel_1;
    } else {
  ...
  if((!(nn != NULL))) {
    return (nlmulret_nlboolean_list_Node_1_ptr_event_Subscription_1_ptr){false, ((list_Node_1_ptr)NULL), ((event_Subscription_1_ptr)NULL)};
  }
  return (nlmulret_nlboolean_list_Node_1_ptr_event_Subscription_1_ptr){true, nn, nn->data};
}
nlmulret_function_29MTnF5pPdQHkucTx_list_SListT_1_ptr_nlnilptr list_SListT_1_each(list_SListT_1_ptr self) {
  return (nlmulret_function_29MTnF5pPdQHkucTx_list_SListT_1_ptr_nlnilptr){list_SListT_1___next, self, NULL};
}
void list_SListT_2_init(list_SListT_2_ptr self) {
  pool_PoolT_5_init((&self->pool));
  self->head = ((list_Node_2_ptr)NULL);
}
list_Node_2_ptr list_SListT_2_push(list_SListT_2_ptr self, event_Subscription_2_ptr x) {
  list_Node_2_ptr n = pool_PoolT_5_add((&self->pool));
  n->next = self->head;
  n->data = x;
  self->head = n;
  return n;
}
nlmulret_nlboolean_list_Node_2_ptr_event_Subscription_2_ptr list_SListT_2___next(list_SListT_2_ptr self, list_Node_2_ptr n) {
  list_Node_2_ptr nn = ({
  ...
  if((!(nn != NULL))) {
    return (nlmulret_nlboolean_list_Node_2_ptr_event_Subscription_2_ptr){false, ((list_Node_2_ptr)NULL), ((event_Subscription_2_ptr)NULL)};
  }
  return (nlmulret_nlboolean_list_Node_2_ptr_event_Subscription_2_ptr){true, nn, nn->data};
}
nlmulret_function_4hLPKyqBUeKea1Uew_list_SListT_2_ptr_nlnilptr list_SListT_2_each(list_SListT_2_ptr self) {
  return (nlmulret_function_4hLPKyqBUeKea1Uew_list_SListT_2_ptr_nlnilptr){list_SListT_2___next, self, NULL};
}
...
list_Node_4_ptr list_SListT_4_push(list_SListT_4_ptr self, event_Subscription_4_ptr x) {
  list_Node_4_ptr n = pool_PoolT_9_add((&self->pool));
  n->next = self->head;
  n->data = x;
  self->head = n;
  return n;
}
nlmulret_nlboolean_list_Node_4_ptr_event_Subscription_4_ptr list_SListT_4___next(list_SListT_4_ptr self, list_Node_4_ptr n) {
  list_Node_4_ptr nn = ({
  ...
  if((!(nn != NULL))) {
    return (nlmulret_nlboolean_list_Node_4_ptr_event_Subscription_4_ptr){false, ((list_Node_4_ptr)NULL), ((event_Subscription_4_ptr)NULL)};
  }
  return (nlmulret_nlboolean_list_Node_4_ptr_event_Subscription_4_ptr){true, nn, nn->data};
}
nlmulret_function_2ugVFY8DvpLjaCeM5_list_SListT_4_ptr_nlnilptr list_SListT_4_each(list_SListT_4_ptr self) {
  return (nlmulret_function_2ugVFY8DvpLjaCeM5_list_SListT_4_ptr_nlnilptr){list_SListT_4___next, self, NULL};
}
void list_SListT_5_init(list_SListT_5_ptr self) {
  pool_PoolT_11_init((&self->pool));
  self->head = ((list_Node_5_ptr)NULL);
}
list_Node_5_ptr list_SListT_5_push(list_SListT_5_ptr self, event_Subscription_5_ptr x) {
  list_Node_5_ptr n = pool_PoolT_11_add((&self->pool));
  n->next = self->head;
  n->data = x;
  self->head = n;
  return n;
...
nlmulret_nlboolean_list_Node_5_ptr_event_Subscription_5_ptr list_SListT_5___next(list_SListT_5_ptr self, list_Node_5_ptr n) {
  list_Node_5_ptr nn = ({
  ...
  if((!(nn != NULL))) {
    return (nlmulret_nlboolean_list_Node_5_ptr_event_Subscription_5_ptr){false, ((list_Node_5_ptr)NULL), ((event_Subscription_5_ptr)NULL)};
  }
  return (nlmulret_nlboolean_list_Node_5_ptr_event_Subscription_5_ptr){true, nn, nn->data};
}
nlmulret_function_4uL4La9ggPQo3LWG_list_SListT_5_ptr_nlnilptr list_SListT_5_each(list_SListT_5_ptr self) {
  return (nlmulret_function_4uL4La9ggPQo3LWG_list_SListT_5_ptr_nlnilptr){list_SListT_5___next, self, NULL};
}
void list_SListT_6_init(list_SListT_6_ptr self) {
  pool_PoolT_13_init((&self->pool));
  self->head = ((list_Node_6_ptr)NULL);
}
list_Node_6_ptr list_SListT_6_push(list_SListT_6_ptr self, event_Subscription_6_ptr x) {
  list_Node_6_ptr n = pool_PoolT_13_add((&self->pool));
  n->next = self->head;
  n->data = x;
  self->head = n;
  return n;
}
nlmulret_nlboolean_list_Node_6_ptr_event_Subscription_6_ptr list_SListT_6___next(list_SListT_6_ptr self, list_Node_6_ptr n) {
  list_Node_6_ptr nn = ({
  ...
  if((!(nn != NULL))) {
    return (nlmulret_nlboolean_list_Node_6_ptr_event_Subscription_6_ptr){false, ((list_Node_6_ptr)NULL), ((event_Subscription_6_ptr)NULL)};
  }
  return (nlmulret_nlboolean_list_Node_6_ptr_event_Subscription_6_ptr){true, nn, nn->data};
}
nlmulret_function_36Fxu1YUGTnPViwL1_list_SListT_6_ptr_nlnilptr list_SListT_6_each(list_SListT_6_ptr self) {
  return (nlmulret_function_36Fxu1YUGTnPViwL1_list_SListT_6_ptr_nlnilptr){list_SListT_6___next, self, NULL};
}
...
void event_SubListT_sub(event_SubListT_ptr self, void* subscriber, function_4SZqu2mhaPbEhCt9x handler) {
  event_Subscription_ptr sub = pool_PoolT_add((&self->pool));
  sub->subscriber = subscriber;
  sub->handler = handler;
  list_SListT_push((&self->list), sub);
}
void event_SubListT_emit(event_SubListT_ptr self, main_event_Event_AnimalDeath_ptr event) {
  {
    nlmulret_function_4uNKE5NRnqLqCGAQu_list_SListT_ptr_nlnilptr _asgnret_1 = list_SListT_each((&self->list));
    function_4uNKE5NRnqLqCGAQu __fornext = _asgnret_1.r1;
    list_SListT_ptr __forstate = _asgnret_1.r2;
    list_Node_ptr __fornextit = ((list_Node_ptr)_asgnret_1.r3);
    while(true) {
      nlmulret_nlboolean_list_Node_ptr_event_Subscription_ptr _asgnret_2 = __fornext(__forstate, __fornextit);
      bool __forcont = _asgnret_2.r1;
      list_Node_ptr _ = _asgnret_2.r2;
      event_Subscription_ptr sub = _asgnret_2.r3;
      if((!__forcont)) {
        break;
      }
      __fornextit = _;
...
void event_SubListT_1_sub(event_SubListT_1_ptr self, void* subscriber, function_5aVoqxB6gdCjr8Dbk handler) {
  event_Subscription_1_ptr sub = pool_PoolT_2_add((&self->pool));
  sub->subscriber = subscriber;
  sub->handler = handler;
  list_SListT_1_push((&self->list), sub);
}
void event_SubListT_1_emit(event_SubListT_1_ptr self, main_event_Event_PlayerAttack_ptr event) {
  {
    nlmulret_function_29MTnF5pPdQHkucTx_list_SListT_1_ptr_nlnilptr _asgnret_1 = list_SListT_1_each((&self->list));
    function_29MTnF5pPdQHkucTx __fornext = _asgnret_1.r1;
    list_SListT_1_ptr __forstate = _asgnret_1.r2;
    list_Node_1_ptr __fornextit = ((list_Node_1_ptr)_asgnret_1.r3);
    while(true) {
      nlmulret_nlboolean_list_Node_1_ptr_event_Subscription_1_ptr _asgnret_2 = __fornext(__forstate, __fornextit);
      bool __forcont = _asgnret_2.r1;
      list_Node_1_ptr _ = _asgnret_2.r2;
...
void event_SubListT_2_sub(event_SubListT_2_ptr self, void* subscriber, function_2knsKLmUuKT1XNx37 handler) {
  event_Subscription_2_ptr sub = pool_PoolT_4_add((&self->pool));
  sub->subscriber = subscriber;
  sub->handler = handler;
  list_SListT_2_push((&self->list), sub);
}
void event_SubListT_2_emit(event_SubListT_2_ptr self, main_event_Event_KeyPressed_ptr event) {
  {
    nlmulret_function_4hLPKyqBUeKea1Uew_list_SListT_2_ptr_nlnilptr _asgnret_1 = list_SListT_2_each((&self->list));
    function_4hLPKyqBUeKea1Uew __fornext = _asgnret_1.r1;
    list_SListT_2_ptr __forstate = _asgnret_1.r2;
    list_Node_2_ptr __fornextit = ((list_Node_2_ptr)_asgnret_1.r3);
    while(true) {
      nlmulret_nlboolean_list_Node_2_ptr_event_Subscription_2_ptr _asgnret_2 = __fornext(__forstate, __fornextit);
      bool __forcont = _asgnret_2.r1;
...
void event_SubListT_4_sub(event_SubListT_4_ptr self, void* subscriber, function_4pPo1THfgEzdsRKw6 handler) {
  event_Subscription_4_ptr sub = pool_PoolT_8_add((&self->pool));
  sub->subscriber = subscriber;
  sub->handler = handler;
  list_SListT_4_push((&self->list), sub);
}
void event_SubListT_4_emit(event_SubListT_4_ptr self, main_event_Event_ObjectMoved_ptr event) {
  {
    nlmulret_function_2ugVFY8DvpLjaCeM5_list_SListT_4_ptr_nlnilptr _asgnret_1 = list_SListT_4_each((&self->list));
    function_2ugVFY8DvpLjaCeM5 __fornext = _asgnret_1.r1;
    list_SListT_4_ptr __forstate = _asgnret_1.r2;
    list_Node_4_ptr __fornextit = ((list_Node_4_ptr)_asgnret_1.r3);
    while(true) {
      nlmulret_nlboolean_list_Node_4_ptr_event_Subscription_4_ptr _asgnret_2 = __fornext(__forstate, __fornextit);
      bool __forcont = _asgnret_2.r1;
...
void event_SubListT_5_sub(event_SubListT_5_ptr self, void* subscriber, function_3FbNvqKjJwxQ8PTnB handler) {
  event_Subscription_5_ptr sub = pool_PoolT_10_add((&self->pool));
  sub->subscriber = subscriber;
  sub->handler = handler;
...
void event_SubListT_5_emit(event_SubListT_5_ptr self, main_event_Event_ObjectTryMove_ptr event) {
  {
    nlmulret_function_4uL4La9ggPQo3LWG_list_SListT_5_ptr_nlnilptr _asgnret_1 = list_SListT_5_each((&self->list));
    function_4uL4La9ggPQo3LWG __fornext = _asgnret_1.r1;
    list_SListT_5_ptr __forstate = _asgnret_1.r2;
    list_Node_5_ptr __fornextit = ((list_Node_5_ptr)_asgnret_1.r3);
    while(true) {
      nlmulret_nlboolean_list_Node_5_ptr_event_Subscription_5_ptr _asgnret_2 = __fornext(__forstate, __fornextit);
      bool __forcont = _asgnret_2.r1;
...
void event_SubListT_6_sub(event_SubListT_6_ptr self, void* subscriber, function_21Fh8bq1X8fScyAZq handler) {
  event_Subscription_6_ptr sub = pool_PoolT_12_add((&self->pool));
  sub->subscriber = subscriber;
  sub->handler = handler;
  list_SListT_6_push((&self->list), sub);
}
void event_SubListT_6_emit(event_SubListT_6_ptr self, main_event_Event_AnimalDamaged_ptr event) {
  {
    nlmulret_function_36Fxu1YUGTnPViwL1_list_SListT_6_ptr_nlnilptr _asgnret_1 = list_SListT_6_each((&self->list));
    function_36Fxu1YUGTnPViwL1 __fornext = _asgnret_1.r1;
    list_SListT_6_ptr __forstate = _asgnret_1.r2;
    list_Node_6_ptr __fornextit = ((list_Node_6_ptr)_asgnret_1.r3);
    while(true) {
      nlmulret_nlboolean_list_Node_6_ptr_event_Subscription_6_ptr _asgnret_2 = __fornext(__forstate, __fornextit);
      bool __forcont = _asgnret_2.r1;
...
void main_EventBusT_init(main_EventBusT_ptr self) {
  event_SubListT_3_init((&self->sublist_AfterEventProcessing));
  event_SubListT_6_init((&self->sublist_AnimalDamaged));
  event_SubListT_init((&self->sublist_AnimalDeath));
  event_SubListT_4_init((&self->sublist_ObjectMoved));
  event_SubListT_5_init((&self->sublist_ObjectTryMove));
  event_SubListT_1_init((&self->sublist_PlayerAttack));
  event_SubListT_2_init((&self->sublist_KeyPressed));
}
void main_EventBusT_subscribeTo_1(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_48GYbkTX7Y82defP6 handler) {
  event_SubListT_2_sub((&self->sublist_KeyPressed), subscriber, (function_56tZRi33ZZDi2HbYj)handler);
}
void main_EventBusT_subscribeTo_2(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_2dyoW7VdhKnP6RUM7 handler) {
  event_SubListT_6_sub((&self->sublist_AnimalDamaged), subscriber, (function_4VfZmwtMyXQD3i1Rs)handler);
}
void main_EventBusT_subscribeTo_3(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_4JskZSUwhCcUTtH3C handler) {
  event_SubListT_1_sub((&self->sublist_PlayerAttack), subscriber, (function_J8dzrJrzsdVnEJaD)handler);
}
void main_EventBusT_subscribeTo_4(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_5TGKfYNMYuyxx1khX handler) {
  event_SubListT_1_sub((&self->sublist_PlayerAttack), subscriber, (function_NPyjwbqhFL4oM5ME)handler);
}
void main_EventBusT_subscribeTo_5(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_35SnSF6zavxH1fTfw handler) {
  event_SubListT_4_sub((&self->sublist_ObjectMoved), subscriber, (function_26hVMSJqZSkzVXCP9)handler);
}
void main_EventBusT_subscribeTo_6(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_2zgpo2WvuXsG7czPg handler) {
  event_SubListT_sub((&self->sublist_AnimalDeath), subscriber, (function_vFwBy7EysRkFoTRv)handler);
}
void main_EventBusT_subscribeTo_7(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_2eEJ4du7BDE4Fsd7P handler) {
  event_SubListT_5_sub((&self->sublist_ObjectTryMove), subscriber, (function_4EUBvqzddbbhyU6Uh)handler);
}
void main_EventBusT_subscribeTo_8(main_EventBusT_ptr self, nlniltype event, void* subscriber, function_5CQuLWJt28bUm2ktu handler) {
  event_SubListT_4_sub((&self->sublist_ObjectMoved), subscriber, (function_49FWJNo9sTqAxBE8z)handler);
}
void main_EventBusT_emit_1(main_EventBusT_ptr self, main_event_Event_KeyPressed event) {
  event_SubListT_2_emit((&self->sublist_KeyPressed), (&event));
}
void main_EventBusT_emit_2(main_EventBusT_ptr self, main_event_Event_PlayerAttack_ptr event) {
  event_SubListT_1_emit((&self->sublist_PlayerAttack), event);
}
void main_EventBusT_emit_3(main_EventBusT_ptr self, main_event_Event_AnimalDeath_ptr event) {
  event_SubListT_emit((&self->sublist_AnimalDeath), event);
}
void main_EventBusT_emit_4(main_EventBusT_ptr self, main_event_Event_AnimalDamaged_ptr event) {
  event_SubListT_6_emit((&self->sublist_AnimalDamaged), event);
}
...
void main_EventBusT_emit_6(main_EventBusT_ptr self, main_event_Event_ObjectMoved_ptr event) {
  event_SubListT_4_emit((&self->sublist_ObjectMoved), event);
}
void main_Object_subscribeTo_1(main_Player_ptr self, nlniltype event, function_48GYbkTX7Y82defP6 handler) {
  main_EventBusT_subscribeTo_1((&main_event_bus), NELUA_NIL, (void*)self, handler);
}
void main_Object_subscribeTo_2(main_Player_ptr self, nlniltype event, function_2dyoW7VdhKnP6RUM7 handler) {
  main_EventBusT_subscribeTo_2((&main_event_bus), NELUA_NIL, (void*)self, handler);
}
void main_Object_subscribeTo_3(main_Animal_ptr self, nlniltype event, function_4JskZSUwhCcUTtH3C handler) {
...
void main_Narrator_subscribeTo_1(main_Narrator_ptr self, nlniltype event, function_5TGKfYNMYuyxx1khX handler) {
  main_EventBusT_subscribeTo_4((&main_event_bus), NELUA_NIL, (void*)self, handler);
}
void main_Narrator_subscribeTo_2(main_Narrator_ptr self, nlniltype event, function_35SnSF6zavxH1fTfw handler) {
  main_EventBusT_subscribeTo_5((&main_event_bus), NELUA_NIL, (void*)self, handler);
}
void main_Narrator_subscribeTo_3(main_Narrator_ptr self, nlniltype event, function_2zgpo2WvuXsG7czPg handler) {
...
bool main_Tile_hasObject(main_Tile_ptr self) {
  return (!list_DList_1_isEmpty((&self->objects)));
}
list_Node_7_ptr main_Tile_addObject_1(main_Tile_ptr self, main_Object_ptr ptr) {
  return list_DList_1_pushHead((&self->objects), ptr);
}
list_Node_7_ptr main_Tile_addObject_2(main_Tile_ptr self, main_Player_ptr ptr) {
  return list_DList_1_pushHead((&self->objects), ((main_Object_ptr)ptr));
}
list_Node_7_ptr main_Tile_addObject_3(main_Tile_ptr self, main_Animal_ptr ptr) {
  return list_DList_1_pushHead((&self->objects), ((main_Object_ptr)ptr));
}
void main_Tile_removeObject_1(main_Tile_ptr self, main_Object_ptr ptr) {
  list_DList_1_remove((&self->objects), ptr->tile_node);
}
void main_Map_subscribeTo_1(main_Map_ptr self, nlniltype event, function_2eEJ4du7BDE4Fsd7P handler) {
  main_EventBusT_subscribeTo_7((&main_event_bus), NELUA_NIL, (void*)self, handler);
}
void main_Map_subscribeTo_2(main_Map_ptr self, nlniltype event, function_5CQuLWJt28bUm2ktu handler) {
...
void main_readInit(main_Map_ptr self_7, nlstring initstr_1) {
  int64_t tileidx = 0;
  {
    nlmulret_function_3HNHEGbg5vJZDY5hN_nlstring_ptr_nlint64 _asgnret_1 = nelua_ipairs_1((&initstr_1));
    function_3HNHEGbg5vJZDY5hN __fornext = _asgnret_1.r1;
...
void main_Map_init(main_Map_ptr self, nlstring initstr) {
  ...
  {
    nlmulret_function_58tSM2G9KSg8qhvEv_main_Tile_arr49_ptr_nlint64 _asgnret_1 = nelua_mipairs_1((&(((main_Tile_arr49_cast*)&self->tiles)->a)));
    function_58tSM2G9KSg8qhvEv __fornext = _asgnret_1.r1;
    ...
    while(true) {
      ...
      __fornextit = _;
      {
        list_DList_1_init((&tile->objects));
      }
    }
  }
    ...
    for(int64_t x = 0; x < 7; x += 1) {
      ...
      if((tile->kind == 1)) {
        ...
        if(main_Tile_hasObject(tile)) {
          ...
          list_Node_7_ptr n = tile->objects.head;
          while((n != NULL)) {
