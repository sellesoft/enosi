 ...
 *
 * Commandline:
 *    --api='glx=1.4' --extensions='GLX_ARB_create_context,GLX_EXT_framebuffer_sRGB' c --debug --header-only --loader
 *
 * Online:
 *    http://glad.sh/#api=glx%3D1.4&extensions=GLX_ARB_create_context%2CGLX_EXT_framebuffer_sRGB&generator=c&options=DEBUG%2CHEADER_ONLY%2CLOADER
 *
 */
