/**
 * Loader generated by glad 2.0.6 on Sun Sep  1 06:29:37 2024
 *
 ...
 *
 * Commandline:
 *    --api='wgl=1.0' --extensions='WGL_ARB_extensions_string,WGL_EXT_extensions_string' c --debug --header-only --loader
 *
 * Online:
 *    http://glad.sh/#api=wgl%3D1.0&extensions=WGL_ARB_extensions_string%2CWGL_EXT_extensions_string&generator=c&options=DEBUG%2CHEADER_ONLY%2CLOADER
 *
 */
